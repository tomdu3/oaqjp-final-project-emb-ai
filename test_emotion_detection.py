...
class TestEmotionDetector(unittest.TestCase):
    def test_emotion_detector(self):
        ...
        res_3 = emotion_detector('I am so sad about this')
        self.assertEqual(res_3['dominant_emotion'], 'sadness')
        
        res_3 = emotion_detector('I am really afraid that this will happen')
        self.assertEqual(res_3['dominant_emotion'], 'fear')
